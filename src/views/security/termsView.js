      ...
      <main id="mainContent" class="main fullWidthPage bg-brand-light dark:bg-brand-dark text-brand-navy dark:text-brand-light" data-pg="FullWidthPage">
        ...
        <section class="py-8">
          <div class="max-w-5xl mx-auto px-4">
            ...
            <p>This website (“<strong>Website</strong>") is owned and operated by Horizon Ridge Credit Union (“<strong>we</strong>”/“<strong>us</strong>”/“<strong>our</strong>”), on our behalf and that of our related bodies corporate. Our registered office is in the United States. Contact: <a href="mailto:contact@horizonridge.cc" class="text-brand-sun underline">contact@horizonridge.cc</a> | <a href="tel:+15022095647" class="text-brand-sun underline">+1 502 209 5647</a>.</p>
