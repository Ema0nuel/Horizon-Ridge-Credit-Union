...
const localTransfer = async () => {
  ...
  function pageEvents() {
    ...
    amountInput.addEventListener("input", () => {
      ...
      let fee = Math.max(1, Math.min(50, val * 0.015));
      feeInput.value = fee.toFixed(2);
    });

    // Form submit
    document.getElementById("local-transfer-form").onsubmit = async function (
      e
    ) {
      e.preventDefault();
            ...
            <div class="p-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="p-6 rounded bg-white dark:bg-gray-800 shadow-sm">
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4"><i class="fa fa-street-view mr-2"></i> Local Fund Transfer</h3>
