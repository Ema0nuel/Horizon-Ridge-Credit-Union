...
export default function InterbankTransferPage() {
  ...
  // Form state
  const [formData, setFormData] = useState<InterbankFormData>({
    amount: 0,
    accounttype: "",
    accountName: "",
    accountNum: "",
  ...
  const [receiptData, setReceiptData] = useState<InterbankFormData & { ipLoc: any } | null>(null);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { amount, accounttype, accountName, accountNum, desc } = formData;
      ...
      await supabase.from("notifications").insert([
        {
          ...
          message: `Your inter-bank transfer of ${fmt(amountNum)} to ${receiptData.accountName} is awaiting admin approval.`,
          type: "info",
          read: false,
        },
      ]);
    ...
    <DashboardShell>
      <div className="p-4 md:p-6 max-w-7xl mx-auto">
        ...
        <nav className="flex items-center gap-1 text-xs text-gray-500 dark:text-gray-400 mb-4">
          ...
          <span>/</span>
          <span className="text-gray-700 dark:text-gray-200">Inter-Bank Transfer</span>
        </nav>
        ...
        {!showReceipt && !showSuccess && codeStep === null ? (
          ...
          otpSent ? (
            ...
            // Step 1a: Inter-Bank Transfer form
            <div className="space-y-6">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                <i className="fa-solid fa-bank mr-2" /> Inter-Bank Fund Transfer
              </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <span className="absolute right-3 top-2.5 text-gray-400"><i className="fa-solid fa-star"></i></span>
                    </div>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-semibold mb-1">Account Holder</label>
                    <div className="relative">
                      <input
                        type="text"
                        name="accountName"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                      />
                      <span className="absolute right-3 top-2.5 text-gray-400"><i className="fa-solid fa-briefcase"></i></span>
                    </div>
                  </div>
                </div>
                <div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <p className="text-xs font-semibold text-gray-500 dark:text-gray-400">Account Type</p>
                  <p className="text-sm font-medium text-gray-900 dark:text-white">{receiptData?.accounttype}</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
